...
class WxPayDownloadBill extends WxPayDataBase
{
    ...
    /**
     * 获取微信支付分配的终端设备号，填写此字段，只下载该设备号的对账单的
     * @return 
     **/
    ...
    /**
     * 设置ALL，返回当日所有订单信息，默认SUCCESS，返回当日成功支付的订单REFUND，返回当日退款订单REVOKED，已撤销的订单
     * @param string $value
     **/
    ...
    /**
     * 获取ALL，返回当日所有订单信息，默认SUCCESS，返回当日成功支付的订单REFUND，返回当日退款订单REVOKED，已撤销的订单的
     * @return 
     **/
    ...
    /**
     * 判断ALL，返回当日所有订单信息，默认SUCCESS，返回当日成功支付的订单REFUND，返回当日退款订单REVOKED，已撤销的订单是否存在
     * @return true 或 false
     **/
