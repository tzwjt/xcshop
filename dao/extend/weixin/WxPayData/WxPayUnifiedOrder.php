<?php
namespace dao\extend\weixin\WxPayData;
/**
 * ok
 * 统一下单输入对象
 * @author widyhu
...
class WxPayUnifiedOrder extends WxPayDataBase
{
    ...
    /**
     * 获取附加数据，在查询API和支付通知中原样返回，该字段主要用于商户携带订单的自定义数据的
     * @return 
     **/
    ...
    /**
     * 获取商户系统内部的订单号,32个字符内、可包含字母, 其他说明见商户订单号的
     * @return 
     **/
    ...
    /**
     * 设置符合ISO 4217标准的三位字母代码，默认人民币：CNY，其他列表详见货币类型
     * @param string $value
     **/
    ...
    /**
     * 获取符合ISO 4217标准的三位字母代码，默认人民币：CNY，其他列表详见货币类型的
     * @return 
     **/
    ...
    /**
     * 判断符合ISO 4217标准的三位字母代码，默认人民币：CNY，其他列表详见货币类型是否存在
     * @return true 或 false
     **/
    ...
    /**
     * 获取APP和网页支付提交用户端ip，Native支付填调用微信支付API的机器IP。的
     * @return 
     **/
    ...
    /**
     * 获取订单生成时间，格式为yyyyMMddHHmmss，如2009年12月25日9点10分10秒表示为20091225091010。其他详见时间规则的
     * @return 
     **/
    ...
    /**
     * 获取订单失效时间，格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。其他详见时间规则的
     * @return 
     **/
    ...
    /**
     * 获取商品标记，代金券或立减优惠功能的参数，说明详见代金券或立减优惠的
     * @return 
     **/
    ...
    /**
     * 设置取如下：JSAPI，NATIVE，APP，详细说明见参数规定
     * @param string $value
     **/
    ...
    /**
     * 获取取如下：JSAPI，NATIVE，APP，详细说明见参数规定的
     * @return 
     **/
    ...
    /**
     * 判断取如下：JSAPI，NATIVE，APP，详细说明见参数规定是否存在
     * @return true 或 false
     **/
    ...
    /**
     * 获取trade_type=NATIVE，此参数必传。此id为二维码中包含的商品ID，商户自行定义。的
     * @return 
     **/
    ...
    /**
     * 获取trade_type=JSAPI，此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 的
     * @return 
     **/
