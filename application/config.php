...
\think\Url::root('/xcshop/index.php?s=');
   ...
   //     'SHOP_MAIN' =>__URL__.'',
    //    '__UPLOAD__' => __ROOT__,
      //  '__MODULE__' => '/'.ADMIN_MODULE,
        ...
        'UPLOAD_GOODS_SKU' => UPLOAD.'/goodsSku/',//存放商品sku图片
        'UPLOAD_GOODS_BRAND' => UPLOAD.'/goodsBrand/',//存放商品品牌图
        'UPLOAD_GOODS_GROUP' => UPLOAD.'/goodsGroup/',//存放商品分组图片
        'UPLOAD_GOODS_CATEGORY' => UPLOAD.'/goodsCategory/',//存放商品分组图片
        ...
        'UPLOAD_AGENT' => UPLOAD.'/agent/',//存放代理商图片
         'UPLOAD_AGENT_SHOP' => UPLOAD.'/agentShop/',//存放代理商体验店图片
        'UPLOAD_SHOP_SITE' => UPLOAD.'/shopSite/',//存放商城站点图片
